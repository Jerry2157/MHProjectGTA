...
public class PlayerCop extends Objeto {
    //Atlases
    ...
    private Animation<TextureRegion> spriteAnimadoCam;         // Animación caminando
    ...
    public PlayerCop(float x, float y, int SceneWidth) {
        stevenCam = new Texture("Characters/Steven/Atlas-StevenCaminandoFinal512.png");

        SceneTam = SceneWidth;
        // Lee la textura como región
        TextureRegion texturaCompleta = new TextureRegion(stevenCam);

...
public class ControllerActionB extends Pantalla {
    ...
    public ControllerActionB(){
        ...
        Image botonJ=new Image(new Texture("Botones/boton.png"));
        botonJ.setSize(50,50);
        botonJ.setPosition(ANCHO/2+200,ALTO/2-350);
        botonJ.addListener(new InputListener(){
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                buttonBPressed= true;
                return true;

...
/**
 * Created by Roberto gerardomagdaleno on 20/11/17.
 *
 */
    ...
    public void moverVertical(TiledMap mapa) {
        ...
        if ( estadoMovimiento== EstadoMovimiento.MOV_ARRIBA) {
            ...
            if ( celdaDerecha==null) {
                ...
                if (nuevaY <= ScreenGatos.ANCHO - sprite.getHeight()) {
                    sprite.setY(nuevaY);
                }
            }
        }
    ...
    public void moverHorizontal(TiledMap mapa) {
        ...
        if ( estadoMovimiento== EstadoMovimiento.MOV_DERECHA) {
            ...
            if ( celdaDerecha==null) {
                ...
                nuevaX += VELOCIDAD_X;
                // Prueba que no salga del mundo por la derecha
                if (nuevaX <= ScreenGatos.ANCHO - sprite.getWidth()) {
                    sprite.setX(nuevaX);
                }
            }
        }

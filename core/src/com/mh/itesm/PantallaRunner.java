 ...
 * - Cámara fija, scroll en el fondoB
...
class PantallaRunner extends Pantalla
{
    ...
    private final MHMain juego;
    private final AssetManager manager;
    private float tiempoMaximo = 4.0f;

    // Fondo
    private FondoB fondoB;
    ...
    public PantallaRunner(MHMain juego) {
        super();
        this.juego = juego;
    ...
    public void render(float delta) {
        ...
        // termina
        if (fondoB.getX()<-3800) {   // Solo para probar la salida
            terminar();
        }
        if (escenaPausa!=null) {
            escenaPausa.draw();

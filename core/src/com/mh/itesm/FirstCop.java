...
public class FirstCop extends Objeto {
    //Atlases
    ...
    public FirstCop(float x, float y, int SceneWidth) {
        ...
        TextureRegion texturaCompleta = new TextureRegion(firstCopRunning);
        // La divide en 4 frames de 32x64 (ver marioSprite.png)
        TextureRegion[][] texturaPersonaje = texturaCompleta.split(256,256);
